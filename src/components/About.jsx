...
const About = () => {
  ...
  <Row>
    ...
    <br/>
    <h6 className='abouttext' >Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Pulvinar mattis nunc sed blandit. Lectus urna duis convallis convallis tellus id.</h6></Col>
  </Row>
